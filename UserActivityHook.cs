            ...
            if ((nCode >= 0) && (OnMouseActivity != null))
            {
                ...
                switch (wParam)
                {
                    case WM_LBUTTONDOWN:
                        ...
                        break;
					case WM_LBUTTONUP: 
						button = MouseButtons.XButton1; // special indication of left mouse button - up
						break;
					case WM_RBUTTONDOWN:
                        ...
                        break;
					case WM_RBUTTONUP: 
						button = MouseButtons.XButton2; // special indication of right mouse button - up
						break;
					case WM_MOUSEWHEEL:
...
//                        mouseDelta = (short)((mouseHookStruct.mouseData >> 16) & 0xffff);
                        mouseDelta = (int)((mouseHookStruct.mouseData >> 16) & 0xffff);
                ...
                //generate event 
                 MouseEventArgs e = new MouseEventArgs(
                                                    ...
                                                    mouseHookStruct.time); // replaced mouseDelta
                //raise it
